...
function alertDayInfo(dd, mm, yy, leap, jd, sday, smonth, syear) { var lunar = new LunarDate(dd, mm, yy, leap, jd); var s = getDayString(lunar, sday, smonth, syear); s += " \u00E2m l\u1ECBch<br>"; s += getDayName(lunar); s += "<br>- Gi\u1EDD \u0111\u1EA7u ng\u00E0y: " + getCanHour0(jd) + " " + CHI[0]; s += "<br>- Ti\u1EBFt: " + TIETKHI[getSunLongitude(jd + 1, 7.0)]; s += "<br>- Gi\u1EDD ho\u00E0ng \u0111\u1EA1o: " + getGioHoangDao(jd); window.parent.postMessage({ type: 'showContent', content: s }, '*') }
